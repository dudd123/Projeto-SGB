...
public class JFrameConsultaCopiaObra extends javax.swing.JFrame {

    private CopiaObra copiaObra;
    private boolean select;
    private boolean disconnectOnClose;
    private String query = "SELECT co.cod_copia_obra as 'ID Cópia', ob.titulo as 'Título', co.cod_obra_literaria as 'Codigo de Obra Literária' from copia_obra as co, obra_literaria as ob WHERE co.cod_obra_literaria = ob.cod_obra_literaria ORDER BY co.cod_copia_obra";
    private ResultSetTableModel result;
    private final TableRowSorter<TableModel> filter;
    
    public JFrameConsultaCopiaObra(boolean select, boolean disconnectOnClose, CopiaObra copiaObra) throws SQLException {
        initComponents();
        
        setTitle("Consulta de Cópias de Obra Literária");
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if(row != -1) {
            ...
            this.copiaObra.setCodCopiaObra(codigo);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(row != -1) {
            ...
            int codigo = (int) result.getValueAt(row, 0);
            CopiaObra copiaObra = new CopiaObra();
            copiaObra.setCodCopiaObra(codigo);
            
            try {
                copiaObra.load();
                
                JFrameCopiaObraCRUD crud;
                crud = new JFrameCopiaObraCRUD(copiaObra, false);
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        try {
            ...
            JFrameCopiaObraCRUD crud;
            crud = new JFrameCopiaObraCRUD(null, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaCopiaObra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaCopiaObra(false, true, null).setVisible(true);
