...
public class JFrameConsultaObraLiteraria extends javax.swing.JFrame {

    private ObraLiteraria obraLiteraria;
    private boolean select;
    private boolean disconnectOnClose;
    private String query = "SELECT cod_obra_literaria as ID, titulo as 'Título' from obra_literaria ORDER BY ID";
    private ResultSetTableModel result;
    private final TableRowSorter<TableModel> filter;
    
    public JFrameConsultaObraLiteraria(boolean select, boolean disconnectOnClose, ObraLiteraria obraLiteraria) throws SQLException {
        initComponents();
        
        setTitle("Consulta de Obra Literária");
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if(row != -1) {
            ...
            this.obraLiteraria.setCodObraLiteraria(codigo);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(row != -1) {
            ...
            obraLiteraria.setCodObraLiteraria(codigo);
            
            try {
                obraLiteraria.load();
                
                JFrameObraLiterariaCRUD crud;
                crud = new JFrameObraLiterariaCRUD(obraLiteraria, false);
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        try {
            ...
            JFrameObraLiterariaCRUD crud;
            crud = new JFrameObraLiterariaCRUD(null, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaObraLiteraria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaObraLiteraria(false, true, null).setVisible(true);
