...
public class JFrameConsultaTipoObra extends javax.swing.JFrame {

    private TipoObra tipoObra;
    private boolean select;
    private boolean disconnectOnClose;
    private String query = "SELECT cod_tipo_obra as ID, descricao as Tipo from tipo_obra ORDER BY ID";
    private ResultSetTableModel result;
    private final TableRowSorter<TableModel> filter;
    
    public JFrameConsultaTipoObra(boolean select, boolean disconnectOnClose, TipoObra tipoObra) throws SQLException {
        initComponents();
        
        setTitle("Consulta de Tipo de Obra Literária");
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if(row != -1) {
            ...
            this.tipoObra.setCodTipoObra(codigo);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if(row != -1) {
            ...
            tipoObra.setCodTipoObra(codigo);
            
            try {
                tipoObra.load();
                
                JFrameTipoObraCRUD crud;
                crud = new JFrameTipoObraCRUD(tipoObra, false);
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        JFrameTipoObraCRUD crud;
        crud = new JFrameTipoObraCRUD(null, false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaTipoObra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JFrameConsultaTipoObra(false, true, null).setVisible(true);
